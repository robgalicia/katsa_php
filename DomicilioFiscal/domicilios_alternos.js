var idclienteG = -1;
var idclientedomiciliofiscalG = -1;
$(document).ready(function() {

    idclienteG = $.get("idclienteG");
    idclientedomiciliofiscalG = $.get("iddomiciliofiscalG");
...
function cargar_datos_ajax(){
    var json = {
        'idcliente' : idclientedomiciliofiscalG
    }

    ajaxPost("domicilios_alternos_edit_all.php", cargar_datos, json);
}
...
function agregar_empleado_ajax(){
    ...
    //formGenerales
    var json = {        
        'idclientedomiciliofiscal' : idclientedomiciliofiscalG,        
    ...
    ajaxPost("domicilios_alternos_insert.php", correctoTabla, json);
}
