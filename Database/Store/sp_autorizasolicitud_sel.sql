...
DROP PROCEDURE IF EXISTS sp_autorizasolicitud_sel $$

CREATE PROCEDURE sp_autorizasolicitud_sel(IN pidautorizasolicitud smallint)  
begin
	...
	where a.idautorizasolicitud=pidautorizasolicitud;
