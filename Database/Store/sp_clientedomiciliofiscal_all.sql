...
DROP PROCEDURE IF EXISTS sp_clientedomiciliofiscal_all $$

CREATE PROCEDURE sp_clientedomiciliofiscal_all(IN pidcliente int)

begin

	select 	idclientedomiciliofiscal, idcliente, nombre, c.nombrecomercial, 
