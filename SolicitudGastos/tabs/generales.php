<div class="ui segment">
    ...
    <div class="ui form" id="formGeneral">
        ...
        <div class="fields">
            ...
            <div class="five wide field">
                <input id="lugar_viaje" tabindex="2" validate="true"></input>
            </div>
        ...
        <div class="fields">
            ...
            <div class="five wide field">
                <select id="tipo_viaje" tabindex="3" validate="true"></select>
            </div>
            <div class="three wide field">
                <label>Cliente:</label>
            </div>
            <div class="five wide field">
                <select id="cliente" tabindex="12" validate="true"></select>
            </div>  
        </div>
        ...
        <div class="fields">
            ...
            <div class="five wide field">
                <input id="motivo" tabindex="4" validate="true"></input>
            </div>
            ...
            <div class="five wide field">
                <input id="km" tabindex="15" validate="true"></input>
            </div>
        </div>
        ...
        <div class="fields">
            ...
            <div class="five wide field">
                <input id="dias" type="number" tabindex="5" validate="true"></input>
            </div>
            <div class="three wide field">
        ...
        <div class="fields">
            ...
            <div class="five wide field">
                <input type="date" id="fecha_inicial" tabindex="6" validate="true">
            </div>
            <div class="three wide field">
                <label>Empleado Beneficiario:</label>
            </div>
            <div class="five wide field">
                <select id="empleado_beneficiario" tabindex="17" validate="true"></select>
            </div>
        ...
        <div class="fields">
            ...
            <div class="five wide field">
                <input type="date" id="fecha_final" tabindex="7" validate="true">
            </div>
